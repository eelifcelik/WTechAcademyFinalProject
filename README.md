...
- Kuruluş Yıllarına Göre Takımlar 
- Belirli Bir Takımın Sezon Başarı Oranı Elde Etme
...
- **Şehirlere Göre Takım Sayıları**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/tak%C4%B1m_sehir.png" alt="" width="400"/>

- **Sezonlara Göre Takımların Ortalama Puanları**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/Sezonlara_gore_ortalama_puan.png" alt="" width="400"/>

- **Ev Sahibi Takımın Kazanma Oranı**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/ev_tak%C4%B1m_kazanma.png" alt="" width="400"/>

- **Yıllara Göre Takım Kurulma Grafiği**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/kurulus_yil.png" alt="" width="400"/>

- **Oyun Verisindeki Korelasyon**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/oyun_korelasyon.png" alt="" width="400"/>

- **Oyun Detayları Verisindeki Korelasyon**
 <img src="https://github.com/eelifcelik/WTechAcademyFinalProject/blob/main/Project_Analysis_Images/oyun_detay_korelasyon.png" alt="" width="400"/>

<br> 
  
## Teşekkür

- [Sisterslab](https://sisterslab.co/) ekibine, bana ve ekip arkadaşlarıma sağladıkları bu güzel eğitim için teşekkür ederim. 
